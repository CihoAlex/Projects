...
namespace Catan
{
    public static class CardsForTest
    {
        //numarul total de carti la inceputul jocului;

        //comparatorii pentru metoda giveDevCard();
        
        public static int kcComp;  // knight card comparator

        public static int vpComp1; // victory point comparator
        public static int vpComp2; // victory point comparator

        public static int rbComp1; // road building comparator
        public static int rbComp2; // road building comparator

        public static int ypComp1; // year of plenty comparator
        public static int ypComp2; // year of plenty comparator

        public static int mcComp1; // monopoly comparator
        public static int mcComp2; // monopoly comparator
            ...
            if (currentPlayer.WheatQty > 0)
                if (currentPlayer.StoneQty > 0)
                    if (currentPlayer.SheepQty > 0)
                    {
                        ...
                        int card = rand.Next(1, gs.CardsLeft); // cod mutat din functia giveDevcard pentru unit testing

                        giveDevCard(gs, currentPlayer, gameType, card);
                        return true;
                    }
                    else
                    {
        ...
        public static void giveDevCard(GameState gs, Player currentPlayer, int gameType, int card) //am adaugat argumentul card pentru unit testing
        {
            ...
            //Random rand = new Random();
            //int card = rand.Next(1, gs.CardsLeft); //cod mutat in functia buydevCard pentru unit testing
